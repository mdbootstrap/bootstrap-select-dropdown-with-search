...
Check out [Bootstrap Select dropdown with search Documentation](https://mdbootstrap.com/docs/standard/extended/select-dropdown-with-search/) for detailed instructions & even more examples.
...
[Bootstrap Multiselect dropdown with search:
![Bootstrap 5 Select dropdown with search](/assets/multiselect.png)](https://mdbootstrap.com/docs/standard/extended/select-dropdown-with-search/#section-multiselect)

[Bootstrap Select dropdown with search and label:
![Bootstrap 5 Select dropdown with search](/assets/with-label.png)](https://mdbootstrap.com/docs/standard/extended/select-dropdown-with-search/#section-with-label)

[Bootstrap Select dropdown with search and disabled options:
![Bootstrap 5 Select dropdown with search](/assets/disabled-options.png)](https://mdbootstrap.com/docs/standard/extended/select-dropdown-with-search/#section-disabled-options)

[Bootstrap Select dropdown with search and visible options:
![Bootstrap 5 Select dropdown with search](/assets/visible-options.png)](https://mdbootstrap.com/docs/standard/extended/select-dropdown-with-search/#section-visible-options)

[Bootstrap Select dropdown with search and icons:
![Bootstrap 5 Select dropdown with search](/assets/icons.png)](https://mdbootstrap.com/docs/standard/extended/select-dropdown-with-search/#section-icons)

[Bootstrap Select dropdown with search inside a modal:
![Bootstrap 5 Select dropdown with search](/assets/search-inside-modal.png)](https://mdbootstrap.com/docs/standard/extended/select-dropdown-with-search/#section-search-inside-modal)
